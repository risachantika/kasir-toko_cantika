...
@section('content')
    <div class="row">
        <div class="col-xl-4 col-lg-6">
            <form  method="POST" class="card card-orange card-outline" action="{{ route('pelanggan.update',['pelanggan'=> $pelanggan->id]) }}">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <x-textarea name="nama" type="text" :value="$pelanggan->nama" />
                    </div>
                    <div class="form-group">
                        <label>Alamat</label>
                    ...
                    <div class="form-group">
                        ...
                        <x-textarea name="nomor_tlp" type="text" :value="$pelanggan->nomor_tlp" />
                    </div>
                </div>
