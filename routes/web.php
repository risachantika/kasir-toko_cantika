...
Route::middleware('auth')->group(function(){
    ...
    Route::get('/laporan/harian/{kasir_id?}',[LaporanController::class,'harian'])->name('laporan.harian');
    Route::get('/laporan/bulanan/{kasir_id?}',[LaporanController::class,'bulanan'])->name('laporan.bulanan');
